...
def backward(head_grads, data, out):
    print(head_grads.ndim)
    print(out.shape)
...
shape = {'x': (1, 3, 32, 32)}
#shape = {'x': (1000)}
check_function(y, forward=forward, backward=backward, numerical_grads=False, in_range=(0.001, 2.0), dtype=dtype, shape=shape, additional_params={'kernel'=[2,2], 'pad'=[0,0],'stride'=[2,2]})
